...
* Detection might be too late, not eal-time. In cases like [TCE](#Event-Definition-Templates), all required events have to be detected first before a TCE is detected. This means that the events might have ended when it is detected